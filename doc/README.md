...
- **UTR #24** — [RST](utr/utr24.rst), [HTML](utr/html/utr24.html) — *The Unicon Preprocessor* (architecture, control flow, and extensions: triple-quoted strings, function-like macros, asserts; build with `make -C doc/utr html`)
